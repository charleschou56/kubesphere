	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtualizationV1alpha1().VirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtualizationV1alpha1().VirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
		&virtualizationv1alpha1.VirtualMachine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtualizationv1alpha1.VirtualMachine{}, f.defaultInformer)
}
